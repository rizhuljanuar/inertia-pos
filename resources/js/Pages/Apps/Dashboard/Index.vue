        ...
        <div class="row">
            ...
            >
              <div class="card-header">
                <span class="font-weight-bold"
                  ><i class="fa fa-chart-bar"></i> SALES CHART 7 DAYS</span
                >
              </div>
              <div class="card-body">
          ...
          <div class="col-md-4">
            ...
            >
              <div class="card-header">
                <span class="font-weight-bold"
                  ><i class="fa fa-chart-bar"></i> PROFITS TODAY</span
                >
              </div>
              <div class="card-body">
                <h5 class="fw-bold">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            >
              ...
              <div class="card-body">
                <DoughnutChart :charData="chartBestProduct" />
              </div>
            </div>
          </div>
          <div class="col-md-6">
            ...
            >
              ...
              <div class="card-body">
                <div v-if="products_limit_stock.length > 0">
                  <ol class="list-group list-groupnumbered">
                    <li
